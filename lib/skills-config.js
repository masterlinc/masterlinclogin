...
// ===================== 默认 3 个精品卡数据（对齐 skills/index.html 内嵌 SKILLS 数组） =====================
// v1.21.0 排序：管理者 AI 效率审计（skill-12，头牌 RedSkill L1）排第一，AI 会议纪要·四栏法第二，AI 写周报法第三。
// 下载：每个 Skill 一个 ZIP 精品包（内含 SKILL.md + README.md + 方法卡，参考 RedSkill 交付规范）。
const DEFAULT_SKILLS = [
  {
    skillId: 'skill-12', name: '管理者 AI 效率审计',
    value: '记录一周工作，按四类拆开算出可释放时间，找到 AI 最该插手的 TOP 3。',
    cat: '决策', tools: ['DeepSeek', 'Kimi', 'GPT'],
    diff: '★★★', time: '记录一周 · 周末审计 30 分钟', format: 'ZIP 精品包 · SKILL.md + 方法卡 + 使用说明',
    file: '/skills/files/skill-12-manager-ai-audit-week.zip',
    dlName: '管理者AI效率审计（精品包）.zip', dlText: '免费下载 · 效率审计精品包',
  ...
  },
  {
    ...
    diff: '★★☆', time: '首次配置 20 分钟 · 每场会 15 分钟', format: 'ZIP 精品包 · SKILL.md + 方法卡 + 使用说明',
    file: '/skills/files/skill-01-ai-meeting-notes-4columns.zip',
    dlName: 'AI会议纪要·四栏法（精品包）.zip', dlText: '免费下载 · 四栏法精品包',
  ...
  },
  {
    ...
    diff: '★★☆', time: '首次搭建 30 分钟 · 每周 20 分钟成稿', format: 'ZIP 精品包 · SKILL.md + 方法卡 + 使用说明',
    file: '/skills/files/skill-04-ai-weekly-report.zip',
    dlName: 'AI写周报法（精品包）.zip', dlText: '免费下载 · 周报法精品包',
